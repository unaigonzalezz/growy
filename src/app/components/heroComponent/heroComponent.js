...
<nav
      ...
      <div className="mx-auto max-w-7xl  lg:px-8">
        <div className="w-full flex flex-col lg:flex-row">
          ...
          <div className="hidden w-full lg:flex justify-between max-lg:bg-white py-5 max-lg:mt-1 max-lg:px-4 max-lg:shadow-lg max-lg:shadow-gray-200 max-lg:h-auto max-lg:overflow-auto transition-all duration-500 delay-200 " id="navbar">
                  ...
                  <div className="flex flex-col sm:flex-row lg:justify-between">
                    <ul className="text-sm text-gray-700 lg:w-1/2">
                      ...
                      <li className="">
                        ...
                        >
                          <div
                            className="bg-indigo-50 rounded-lg w-12 h-12 flex items-center justify-center"
                          >
                            <svg
                              width="38"
                              height="38"
                        ...
                        >
                          ...
                          <div className="ml-4 w-4/5">
                            ...
                            >
                              Analytics
                              <span
                                className="bg-indigo-50 text-indigo-500 text-xs font-medium mr-2 px-2.5 py-1 rounded-full h-5 ml-4"
                                >New</span
                              >
                            </h5>
                            <p className="text-xs font-medium text-gray-400">
            ...
            <a href="https://pagedone.io/" className="hidden lg:flex items-center">
    ...
    <section
      className="pt-8 lg:pt-32 bg-[url('https://pagedone.io/asset/uploads/1691055810.png')] bg-center bg-black bg-cover"
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative text-center">
        ...
        >
          <span className="font-inter text-xs font-medium text-gray-900 ml-3"
            >¡Aprende sobre la onicofagia!</span
          >
          <a
            href="javascript:;"
...
La onicofagia es como tener una fiesta de picoteo, pero con tus propias uñas como aperitivos.
        </p>
        <a
          href="javascript:;"
