...
return (
    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 text-white flex justify-center ">
            ...
            <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 text-white flex justify-center">
                    <div className="flex flex-col lg:flex-row justify-between gap-8">
                    <div className="w-full lg:w-8/12">
                                    <img className="w-full h-full border-rad rounded-lg" src="https://reviveclinic.com/wp-content/uploads/2020/04/stock-image-113032662.jpg" alt="A group of People" />
                            </div>
                            <div className="w-full lg:w-5/12 flex flex-col justify-center">
                            <h1 className="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 dark:text-white pb-4">¿Y que puedo hacer?</h1>
                    <p className="font-normal text-base leading-6 text-gray-600 dark:text-white">Si bien es cierto que parece un hábito inofensivo, no lo es, la Onicofagia está reconocida como un tipo de Canibalismo, llamado Auto canibalismo, donde una persona se come una parte de si misma, como un pellejo de la uña, la propia uña o la carne del labio. Cosas tan banales como abrir una lata, retirar la piel de una mandarina o incluso rascarse resultan un reto para los pacientes de Onicofagia, ya que la uña es de gran ayuda en tareas cotidianas.
